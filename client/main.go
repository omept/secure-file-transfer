...
func main() {
	...
	//👆🏽 pro tip: the extra 28byte is the size of the initialization vector (nonce) and Auth flag. My Go implementation  uses  Galois/Counter Mode for the initialization vector (nonce).
